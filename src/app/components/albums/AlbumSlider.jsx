...
import data from "../data/data"; // Adjust the path based on your project structure
    ...
    <>
      ...
      >
        {albums?.map((thumb, index) => {
          return (
            <SwiperSlide key={index} className="relative group overflow-hidden border-2 thumb-transparent w-[254px] rounded-[10px]">
              <div className="relative w-[195px] h-[195px] sm:w-[360px] sm:h-[360px] md:w-[240px] md:max-h-[240px] cursor-pointer">
                <Image
                  ...
                  priority
                  alt=""
                  className="object-contain group-hover:scale-185 transition-all duration-300"
                />
              </div>
            </SwiperSlide>
          );

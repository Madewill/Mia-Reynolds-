...
const Player = () => {
  return (
    ...
    <motion.div
      ...
      <div className="container mx-auto w-[100%] flex flex-col  justify-between items-center xl:flex-row">
        {/* text & avatar img */}
        ...
        <div className="w-full max-w-4xl">
          ...
          <AudioPlayer loop preload="none" color="#fff" volume={40}
            volumePlacement="top"
            src="/assets/freedom.mp3" style={{
